	...
	<div class="container">
			<div class="card card-container">
				...
				<a href="manlogin.php" class="forgot-password">
	...
	<?php
			...
			if (isset($_POST["username"])){
				...
				$role = $_POST["role"];
				$result = $conn->query("SELECT * FROM manager WHERE username='$username'") or die($mysqli->error());
				if ( $result->num_rows > 0 ) {				
					...
					$sql = "insert into manager (fullname, email, username, password, roles) values(?,?,?,?,?)";
